...
json = "{}"
# create an instance of StudySubjectDemographicsApi from a JSON string
study_subject_demographics_api_instance = StudySubjectDemographicsApi.from_json(json)
# print the JSON string representation of the object
print(StudySubjectDemographicsApi.to_json())

# convert the object into a dict
study_subject_demographics_api_dict = study_subject_demographics_api_instance.to_dict()
# create an instance of StudySubjectDemographicsApi from a dict
study_subject_demographics_api_from_dict = StudySubjectDemographicsApi.from_dict(study_subject_demographics_api_dict)
```
