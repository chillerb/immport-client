...
json = "{}"
# create an instance of VKirTypingResult from a JSON string
v_kir_typing_result_instance = VKirTypingResult.from_json(json)
# print the JSON string representation of the object
print(VKirTypingResult.to_json())

# convert the object into a dict
v_kir_typing_result_dict = v_kir_typing_result_instance.to_dict()
# create an instance of VKirTypingResult from a dict
v_kir_typing_result_from_dict = VKirTypingResult.from_dict(v_kir_typing_result_dict)
```
